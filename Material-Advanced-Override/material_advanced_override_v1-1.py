...
bpy.types.Scene.OW_only_selected = bpy.props.BoolProperty(name='Affect Only Selected', default=False)
...
class MaterialOverrideTools(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        row.prop(context.scene, 'OW_vis_hide_camera', toggle=True, icon='RESTRICT_VIEW_ON')
